...
[전체 흐름]
    ...
    COOLDOWN (15초)
      ...
      -> [수정] enemy_hp==1 이 되는 순간, 15초를 안 채워도 즉시 TRACK 전이
...
from socamaca_msgs.msg import TeamStatus
...
# ----------------------------------------------------------
# socamaca-ui 연동 토픽 (휴먼인더루프 발사 승인).
...
TOPIC_STATUS = "status"                    # socamaca_msgs/TeamStatus
...
class MissionManager(Node):
    ...
    def compute_ui_mission_state(self) -> str:
        """
        내부 State(PATROL/WAIT_COMMAND/COOLDOWN/TRACK/RETURN)를 socamaca-ui가
    ...
    def state_machine(self):
        ...
        # ---------- COOLDOWN ----------
            ...
            # [수정] 상대 HP가 1이 된 순간, 15초를 다 채우지 않고 즉시 TRACK 으로
