...
export function ScoreBoard({ ros }: { ros: ROSLIB.Ros }) {
  ...
  const blue = useTopic<TeamStatusMsg>(ros, topics.status("blue"), "socamaca_msgs/TeamStatus");
  const red = useTopic<TeamStatusMsg>(ros, topics.status("red"), "socamaca_msgs/TeamStatus");
