...
class JudgeBridge:
    ...
    def __init__(self, url: str, dry_run: bool = False, connect_timeout: float = 5.0):
        ...
        self.hit_topic = roslibpy.Topic(self.client, "/judge/hit_event", "socamaca_msgs/HitEvent")
        self.det_topic = roslibpy.Topic(self.client, "/judge/detections", "socamaca_msgs/Detections")
